...
contador = 1   #[1]. mi variable de control inicia en un valor
while ( contador <= FINAL):  #mi variable de control debe ser comparada contra el valor final
    #[2]. ENTRADAS 
    ...
    contador = contador + 1   #mi variable de contro debe incrementada antes de regresar al bucle
