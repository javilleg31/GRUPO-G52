...
#[2]. ENTRADAS 
nombreEstudiante = leerCadena( "NOMBRE: ") #nombreEstudiante = input("ESTUDIANTE: ")
nota1 = leerFlotante( "NOTA 1: " )         #nota1 = float(input("NOTA 1:"))
nota2 = leerFlotante( "NOTA 2: " )         #nota2 = float(input("NOTA 2:"))
nota3 = leerFlotante( "NOTA 3: " )         #nota3 = float(input("NOTA 3:"))
